    ...
    <div>
      ...
      <div class="lg:hidden">
        ...
        <div v-if="showMenu" class=" absolute mt-8 right-0 left-0 flex flex-col shadow-lg bg-black z-50">
          ...
          <router-link to="/manage" class="border-b px-8 py-4">Manage</router-link>
          ...
          <router-link to="/start" class="border-2 rounded mx-8 text-center text-black bg-white border-white py-2 mt-4 mb-8">START FOR FREE</router-link>
        </div>
      </div>

      <!--NAV-->
      <div class="hidden lg:flex items-center">
        <router-link class="mx-8 text-lg" to="/explore">Explore</router-link> 
        <router-link class="mx-8 text-lg opacity-60" to="/manage">Manage</router-link> 
        ...
        <router-link class="border mx-3 text-center rounded bg-black border-black p-2" to="/start">START FOR FREE</router-link>
      </div>
    </div>
  </div>
</template>
