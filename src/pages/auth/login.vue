  ...
  <div class="h-screen w-screen flex flex-row items-center justify-center relative overflow-hidden">
    ...
    <div class="absolute top-0 w-screen left-0 flex flex-row items-center justify-between px-20 py-10 pt-10 z-10">
      ...
      <div class="dark:text-gray-500 text-gray-500 text-sm">
        Don't have an account? <router-link class="text-blauw font-semibold" to="/signup">Sign up here?</router-link>
      </div>
    </div>
    <div class="flex flex-col items-center justify-center z-50" style="width: 500px">
      <div class="w-full" :class="{'shake' : error_animation}" >
          <h2 class="lg:text-4xl tracking-tighter font-semibold sm:text-4xl text-center dark:text-white">Welcome back!</h2>
          <p class="text-gray-600 dark:text-gray-500 leading-none text-center mb-20">Ready to rock the world?</p>
          ...
          <div class="my-10 flex flex-col items-start justify-start w-full">
            ...
            <input tabindex="1" id="email" autocomplete="username" type="text" required class=" shadow-xl hover:bg-gray-100 transition duration-300 px-3 py-2 rounded-xl form-input2 dark:text-gray-200 dark:hover:bg-gray-900 dark:hover:border-gray-900 w-full mb-4 focus:ring-blauw focus:ring-2" placeholder="Email address" v-model="input.email">


            <div class="w-full flex items-center justify-start mb-1"><span class="font-semibold dark:text-white text-sm pl-2 shadow-xl">Password <a href="#" class="text-gray-600 text-xs dark:hover:text-red-500 transition duration-150">Lost password?</a></span></div>
          ...
          <button @click="login()" class="text-sm font-bold bg-gray-100 dark:bg-blauw hover:bg-indigo-500 text-white w-full py-4 rounded-xl mr-2 capitalize focus:outline-none transition duration-300">Sign in</button>
      </div>
      <div class="mt-4">
